...
const defaultEvmTargets: { [key: string]: string } = {
  ...
  "0.8.22": "shanghai",
  "0.8.23": "shanghai",
<<<<<<< HEAD:v-next/hardhat/src/internal/builtin-plugins/solidity/build-system/solc-info.ts
  "0.8.24": "shanghai",
  "0.8.25": "cancun",
  "0.8.26": "cancun",
  "0.8.27": "cancun",
  ...
  "0.8.33": "osaka",
=======
>>>>>>> 0f69d949197497ebc6a1ee225cb405a2df0eaa9e:packages/hardhat-core/src/internal/solidity/compiler/solc-info.ts
};

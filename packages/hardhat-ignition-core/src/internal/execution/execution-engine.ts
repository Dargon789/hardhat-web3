...
<<<<<<< HEAD:v-next/hardhat-ignition-core/src/internal/execution/execution-engine.ts
    private readonly _disableFeeBumping: boolean,
    private readonly _maxRetries: number,
    private readonly _retryInterval: number,
=======
    private readonly _disableFeeBumping: boolean
>>>>>>> 0f69d949197497ebc6a1ee225cb405a2df0eaa9e:packages/hardhat-ignition-core/src/internal/execution/execution-engine.ts
  ) {}
